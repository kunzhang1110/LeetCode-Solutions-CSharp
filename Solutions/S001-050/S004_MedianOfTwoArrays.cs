...
{
    public class S004_MedianOfTwoArrays
    {
        ...
        //    if (total_length % 2 == 1)
        //        return FindKth(nums1, 0, nums2, 0, (total_length + 1) / 2);
        //    else
        //        return (FindKth(nums1, 0, nums2, 0, (total_length + 1) / 2) + FindKth(nums1, 0, nums2, 0, (total_length + 1) / 2 + 1)) / 2;
        //}
